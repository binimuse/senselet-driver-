...
class GlobalStyle {
  ...
  static const TextStyle viewAll =
      TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: themeColor);
  ...
  static const TextStyle courierType =
      TextStyle(fontSize: 15, color: Color(0xFF515151));
  static const TextStyle courierTitle =
      TextStyle(fontSize: 15, fontWeight: FontWeight.bold);
  static const TextStyle deliveryTotalPrice =
      TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: themeColor);
  ...
  static const TextStyle shoppingCartTotalPrice =
      TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: themeColor);
  ...
  static const TextStyle textPrice =
      TextStyle(fontSize: 16, color: themeColor, fontWeight: FontWeight.bold);
  ...
  static const TextStyle orderAction =
      TextStyle(fontSize: 12, color: themeColor, fontWeight: FontWeight.bold);
  ...
  static const TextStyle preferredMerchant =
      TextStyle(color: SOFT_BLUE, fontWeight: FontWeight.bold, fontSize: 12);
